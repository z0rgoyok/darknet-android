...
char *voc_names[] = {"nail"};//, "bicycle", "bird", "boat", "bottle", "bus", "car", "cat", "chair", "cow", "diningtable", "dog", "horse", "motorbike", "person", "pottedplant", "sheep", "sofa", "train", "tvmonitor"};
image voc_labels[1];

void train_yolo(char *cfgfile, char *weightfile)
{
    char *train_images = "/home/user/Develop/darknet/my/train.txt";
    char *backup_directory = "/home/user/Develop/darknet/my/backup/";
    srand(time(0));
    data_seed = time(0);
